 ...
 */
package com.andado.jobextra.model.pets;
 ...
 * table name and pagination rows is read from the DynamoDBConfiguration class in the
 * com.amazonaws.apigateway.configuration package. Credentials for the DynamoDB client are read from
 * the environment variables in the Lambda instance.
 * <p/>
 * This class is a singleton and should only be accessed through the static getInstance method. The
 * constructor is defined as protected.
 */
@Component
